...
export default function Contact({ onNavigate }: { onNavigate: (view: any) => void }) {
  return (
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-gray-100 text-center">
          ...
          <p className="text-lg text-gray-500 mb-10 max-w-2xl mx-auto">
            Tem alguma dúvida, sugestão ou quer reportar um problema? Estamos à disposição para ouvir você.
          </p>
